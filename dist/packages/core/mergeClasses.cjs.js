...
function mergeClasses() {
  ...
  for (let i = 0; i < arguments.length; i++) {
    ...
    if (typeof className === 'string' && className !== '') {
      ...
      if (sequenceIndex === -1) {
        ...
        const sequenceId = className.substr(sequenceIndex, constants.SEQUENCE_SIZE); // Handles a case with mixed classnames, i.e. "ui-button ATOMIC_CLASSES"
  ...
  let atomicClassNames = reduceToClassNameForSlots.reduceToClassName(resultDefinitions, dir); // Each merge of classes generates a new sequence of atomic classes that needs to be registered
